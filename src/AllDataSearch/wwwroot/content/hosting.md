...
##  [/AllDataSearch.Client](https://github.com/NetCoreTemplates/blazor-tailwind/tree/main/AllDataSearch.Client)
...
## [/AllDataSearch](https://github.com/NetCoreTemplates/blazor-tailwind/tree/main/AllDataSearch)

The .NET 6 `/AllDataSearch` backend server is required for this App's dynamic functions including the Hello API on the home page
