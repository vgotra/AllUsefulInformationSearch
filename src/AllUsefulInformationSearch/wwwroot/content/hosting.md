...
##  [/AllUsefulInformationSearch.Client](https://github.com/NetCoreTemplates/blazor-tailwind/tree/main/AllUsefulInformationSearch.Client)
...
## [/AllUsefulInformationSearch](https://github.com/NetCoreTemplates/blazor-tailwind/tree/main/AllUsefulInformationSearch)

The .NET 6 `/AllUsefulInformationSearch` backend server is required for this App's dynamic functions including the Hello API on the home page
