    ...
    : IPostsArchiveFileProcessingService
{
    ...
    protected virtual async ValueTask UpdateStatusAsync(WikipediaDbContext dbContext, int fileId, ProcessingStatus status, CancellationToken cancellationToken) =>
