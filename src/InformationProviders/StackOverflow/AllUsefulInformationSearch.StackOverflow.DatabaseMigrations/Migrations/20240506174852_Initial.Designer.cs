...
namespace AllUsefulInformationSearch.StackOverflow.DatabaseMigrations.Migrations
{
    ...
    [Migration("20240506174852_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AllUsefulInformationSearch.StackOverflow.Models.Entities.AcceptedAnswerCommentEntity", b =>
                {
            ...
            modelBuilder.Entity("AllUsefulInformationSearch.StackOverflow.Models.Entities.AcceptedAnswerEntity", b =>
                {
            ...
            modelBuilder.Entity("AllUsefulInformationSearch.StackOverflow.Models.Entities.PostCommentEntity", b =>
                {
                    b.Property<int>("WebDataFileId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AllUsefulInformationSearch.StackOverflow.Models.Entities.PostEntity", b =>
                {
                    b.Property<int>("WebDataFileId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AllUsefulInformationSearch.StackOverflow.Models.Entities.WebDataFileEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AllUsefulInformationSearch.StackOverflow.Models.Entities.AcceptedAnswerCommentEntity", b =>
                {
                    b.HasOne("AllUsefulInformationSearch.StackOverflow.Models.Entities.AcceptedAnswerEntity", "AcceptedAnswer")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("AllUsefulInformationSearch.StackOverflow.Models.Entities.AcceptedAnswerEntity", b =>
                {
                    b.HasOne("AllUsefulInformationSearch.StackOverflow.Models.Entities.PostEntity", "Post")
                        .WithOne("AcceptedAnswer")
                        .HasForeignKey("AllUsefulInformationSearch.StackOverflow.Models.Entities.AcceptedAnswerEntity", "PostWebDataFileId", "PostId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("AllUsefulInformationSearch.StackOverflow.Models.Entities.PostEntity", b =>
                {
                    b.HasOne("AllUsefulInformationSearch.StackOverflow.Models.Entities.WebDataFileEntity", "WebDataFile")
                        .WithMany("Posts")
